...
public class CodecHtml {
	...
	/**
	 * Encode string to HTML-safe text. Extra characters are encoded as
	 * decimals, and five special characters are replaced with their HTML
	 * values: <li>' with &amp;#039;</li> <li>" with &amp;quot;</li> <li>&amp;
	 * with &amp;amp;</li> <li>&lt; with &amp;lt;</li> <li>&gt; with &amp;gt;</li>
	 *
	 * @param string
	 *            input string
	...
	public String encode(String string) {
		...
		int n = string.length();
		StringBuilder buffer = new StringBuilder((int) (n * newSizeFactor));
